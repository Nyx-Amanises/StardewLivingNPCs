...
internal sealed class BehaviorMemory
{
    ...
    /// <summary>主机关系视图发布时使用的权威 NPC 名单。</summary>
    public IReadOnlyList<string> GetTrackedNpcNames()
    {
        ...
        bool updateNicknameState = false)
    {
        ...
        {
            NicknamePreferenceService.UpdateStateFromMemory(state, storedMemory, currentTotalDays, currentTimeOfDay);
        }
