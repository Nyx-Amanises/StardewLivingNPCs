...
- 记录互动节奏，例如今天聊过几次、是否连续几天都来打招呼、上次聊天隔了多久。
...
LivingNPCs 还会记录互动节奏。每天第一次打招呼、同一天重复聊天、连续几天都来聊天、隔了很多天才再见面，都会让 NPC 的短期状态和行为概率略有不同。比如连续打招呼会形成熟悉的日常感，但同一天太频繁地反复聊天会让 NPC 稍微需要一点空间。
...
当同一个 NPC 与你逐渐熟悉后，`Auto` 模式下更容易出现走近、转向或自然回应。查看记忆时也会显示“对玩家熟悉度”“互动节奏”“行为倾向”“当前场景”和“情境影响”，ValleyTalk prompt 里会收到对应上下文。
