...
internal static class ThinkingDialogueController
{
    ...
    public static void Start(NPC npc)
    {
        ...
        var dialogue = new GameDialogue(npc, ThinkingDialogueKey, $"{baseText}...")
        {
    ...
    public static bool TryDiscardInactiveTop(NPC npc, Stack<GameDialogue> dialogues)
    {
    ...
    private static void Remove(NPC npc, GameDialogue dialogue)
    {
        if (dialogue == null)
        {
            return;
    ...
    private static void Remove(NPC npc, Predicate<GameDialogue> predicate)
    {
        if (predicate != null)
        {
    ...
    internal static bool IsThinkingDialogue(GameDialogue dialogue)
    {
        if (dialogue == null)
        {
            return false;
