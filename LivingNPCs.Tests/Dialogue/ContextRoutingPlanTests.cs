...
public sealed class ContextRoutingPlanTests
{
    ...
    public void CloneCopiesDetailsAndStaysIndependent()
    {
        ...
        // Changing an assembly plan must not mutate the original module selection.
    ...
    [Fact]
    public void ConversationCuesMatchFutureScheduleQuestionsCaseInsensitively()
    {
        // Schedule questions still select the future-schedule text locally.
        ...
        Assert.False(ConversationCues.ContainsAny("   ", ConversationCues.FutureSchedule));
