...
add("instructionsLivingNpcImmediateTravelOptimized", "Only accepted now => companion_outing. Escort/guide/schedule walk 20 minutes; true outing 60. delayMinutes 1-10 for brief prep. Decline only for strong reasons. No route mechanics in visible text.", "只有现在接受才用companion_outing。护送/带路/顺路日程为20分钟；真正同游60分钟。短暂准备delayMinutes 1-10。只有强理由才拒绝。可见文本不写路线机制。");
add("instructionsLivingNpcTravelConsent", "Set travelConsent to accepted_now, accepted_later, declined, tentative, or none. accepted_now includes brief preparation. accepted_later means later or another day. declined means no or not now. tentative means unclear interest. none means travel was not discussed. Do not request companion_outing unless travelConsent is accepted_now.", "travelConsent只能为accepted_now, accepted_later, declined, tentative, none。accepted_now包含短暂准备；accepted_later表示晚点或改天；declined表示拒绝或现在不行；tentative表示态度含糊；none表示未讨论出行。除accepted_now外不得请求companion_outing。");
